# Scripts de Base de Datos - Guía de Uso
...
- Muestra estadísticas detalladas de empresas y usuarios
- Lista todos los usuarios por rol y empresa
- Verifica credenciales de testing
- Detecta problemas potenciales (usuarios sin empresa, roles inválidos)
...
- Crea 3 empresas (ERP Solutions, Demo Company, Test Industries)
- Crea 5 usuarios básicos (uno por cada rol)
- Mantiene datos existentes, solo agrega lo que falta
...
- Todo lo anterior +
- Crea 3 usuarios adicionales de testing
- Ideal para desarrollo y QA
...
- Inicializa desde cero con datos básicos
