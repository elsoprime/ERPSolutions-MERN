            ...
            {menuItems.map((item) => (
                <div key={item.id} className="relative">
                    {item.ISubMenu ? (
                                    ...
                                    <div className="py-2">
                                        {item.ISubMenu.map((subItem) => (
                                            <Link
                                                key={subItem.id}
                                                href={subItem.link}
                                                className={`flex items-center px-4 py-2 text-sm hover:bg-gray-50 transition-colors duration-200 ${isActiveLink(subItem.link)
                        ...
                        <Link
                            href={item.link || '#'}
                            className={`flex items-center space-x-1 px-3 py-2 text-sm font-medium transition-colors duration-200 ${isActiveLink(item.link || '')
                                    ? 'text-purple-600'
