...
export default function LoginLayout() {
  ...
  return (
    <div className='hidden lg:block lg:w-3/4 relative z-20'>
      ...
      <div className='absolute inset-0 flex items-center justify-center px-20 bg-gray-900/40 bg-opacity-80 text-white z-10'>
        <div
          className='p-2'
      ...
      <div className='absolute inset-0 bg-gradient-to-br from-black/60 via-gray-600/20 to-black/90 backdrop-blur-xs z-5'></div>
    </div>
  )
}
